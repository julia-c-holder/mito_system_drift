...
prefix <- "results/5/mito_auto_5_"

print(id)
num1 <- 2*as.integer(id) - 1
file_name <- paste(prefix, num1,"_pheno_", suffix, sep="")
...
swapped_vars <- var_collector(normed)

print("done!")

## OUTPUT CSV
out_file <- paste("results/swapped/variances/rep5_", num1,"within_pheno_", suffix, sep="")
